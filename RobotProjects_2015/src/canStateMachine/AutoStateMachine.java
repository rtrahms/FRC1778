...
public class AutoStateMachine {
	...
	{	
		...
		// STATE MACHINE 3: add a simple lift state machine (state & event list)
		createSimpleLiftSM(3);
		
		// STATE MACHINE 4: add a transport state machine (state & event list)
		createTransportSM(4);
		
		// STATE MACHINE 5: add a stop-start-repeat state machine (state & event list)
		createStopStartRepeatSM(5);
	...
	private void createTurnaroundSM(int index) {
		...
		boolean isPwm = false;
		IdleState startIdle = new IdleState("<Start Idle State>");
		TurnState turn180degState = new TurnState("<Turn Around State>",180.0, 0.5);
		IdleState deadEnd = new IdleState("<Dead End State>");
		...
		gyro1.associateNextState(deadEnd);
		...
		//autoStates0.add(startIdle);
		//autoStates0.add(turn180degState);
		//autoStates0.add(deadEnd);
		
		//autoEvents0.add(timer1);
		//autoEvents0.add(gyro1);
	...
	private void createSimpleLiftSM(int index) {
		...
		/*
		autoStates0.add(startIdle);
		autoStates0.add(liftDown1);
		autoStates0.add(liftDown2);
		autoStates0.add(liftDown3);
		autoStates0.add(liftUp1);
		autoStates0.add(liftUp2);
		autoStates0.add(liftUp3);
		autoStates0.add(deadEnd);
		
		autoEvents0.add(timer_idle);
		autoEvents0.add(timer_liftDown1);
		autoEvents0.add(timer_liftDown2);
		autoEvents0.add(timer_liftDown3);
		autoEvents0.add(timer_liftUp1);
		autoEvents0.add(timer_liftUp2);
		autoEvents0.add(timer_liftUp3);
		*/
	...
	private void createTransportSM(int index) {
		...
		autoStates0.add(driveBackward1);
		autoStates0.add(liftUp1);
		autoStates0.add(liftUp2);
		autoStates0.add(liftDown1);
		autoStates0.add(liftDown2);
		...
		autoEvents0.add(timer_idle);
		autoEvents0.add(timer_driveForward1);
		autoEvents0.add(timer_driveForward2);
		autoEvents0.add(timer_driveForward3);
		autoEvents0.add(timer_driveBackward1);
		autoEvents0.add(timer_liftUp1);
		autoEvents0.add(timer_liftUp2);
		autoEvents0.add(timer_liftDown1);
		autoEvents0.add(timer_liftDown2);
		autoEvents0.add(timer_liftDown3);
		autoEvents0.add(gyro_turn1);
		*/
