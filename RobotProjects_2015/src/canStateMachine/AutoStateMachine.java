...
public class AutoStateMachine {
	...
	{	
		...
		//*** STATE MACHINE 2: add a carry tote state machine (state & event list)
		createCarryToteSM(2);
		
		//--- STATE MACHINE 3: add a do nothing state machine
		createDoNothingSM(3);

		//*** STATE MACHINE 4: add a carry recycle can state machine (state & event list)
		createCarryRecycleCanSM(4);
		
		//--- STATE MACHINE 5: add a do nothing state machine
		createDoNothingSM(5);
		
		//*** STATE MACHINE 6: add a full recycle can & tote transport state machine (state & event list)
		createTransportSM(6);	
	...
	// 5) lowers tote
	// 6) backs up a bit
	private void createCarryToteSM(int index) {
		...
		TimeEvent timer_idle = new TimeEvent(0.1);  // timer event for start
		...
		timer_liftUp1.associateNextState(turnRight1);
		gyro_turnRight1.associateNextState(driveForward2);
		timer_driveForward2.associateNextState(liftDown2);
		timer_liftDown2.associateNextState(driveBackward1);
		...
		turnRight1.addEvent(gyro_turnRight1);
	...
	private void createCarryRecycleCanSM(int index) {
		...
		timer_liftDown1.associateNextState(driveForward1);
		timer_driveForward1.associateNextState(liftUp1);
		timer_liftUp1.associateNextState(turnLeft1);
		gyro_turnLeft1.associateNextState(driveForward2);
		timer_driveForward2.associateNextState(liftDown2);
		timer_liftDown2.associateNextState(driveBackward1);
		timer_driveBackward1.associateNextState(deadEnd);
		...
		driveForward1.addEvent(timer_driveForward1);
		liftUp1.addEvent(timer_liftUp1);
		turnLeft1.addEvent(gyro_turnLeft1);
		driveForward2.addEvent(timer_driveForward2);
		liftDown2.addEvent(timer_liftDown2);
		driveBackward1.addEvent(timer_driveBackward1);
	...
	private void createTransportSM(int index) {
		...
		TimeEvent timer_driveForward1 = new TimeEvent(2.0);  // timer event for drive forward 1
		TimeEvent timer_liftUp1 = new TimeEvent(2.0);  // timer event for lift up 1
		TimeEvent timer_driveForward2 = new TimeEvent(2.0);  // timer event for drive forward 2
		...
		timer_liftUp2.associateNextState(turnLeft1);
		gyro_turnLeft1.associateNextState(driveForward3);
	...
	private void createSimpleLiftSM(int index) {
		...
		TimeEvent timer_liftDown1 = new TimeEvent(3.0);  // timer event for lift down 1
		TimeEvent timer_liftUp1 = new TimeEvent(3.0);  // timer event for lift up 1
		TimeEvent timer_liftDown2 = new TimeEvent(3.0);  // timer event for lift down 2
		TimeEvent timer_liftUp2 = new TimeEvent(3.0);  // timer event for lift up 2
		TimeEvent timer_liftDown3 = new TimeEvent(3.0);  // timer event for lift down 3
		TimeEvent timer_liftUp3 = new TimeEvent(3.0);  // timer event for lift up 3
